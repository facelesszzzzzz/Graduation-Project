...
unsigned char gCardBlue[4]={87,179,24,181};//蓝色卡
unsigned char gCardWhite[4]={23,46,132,180};//白卡
...
//			printf("SN[%d] >> %d\r\n",i,SN[i]);
//		}
				if(SN[0] == gCardWhite[0] && SN[1] == gCardWhite[1] &&
					 SN[2] == gCardWhite[2] && SN[3] == gCardWhite[3])
				{
					gState.ALL |= 0x02;
//					OLED_SHOWBMP(gState);
				}		
//				else
//				{	
//					u3_printf("Card Error!!");
//					if(Beep_flag == 1)	//若处于安防模式，则可以实现报警
//					{
//						BEEP = 0;
//					}
//				}
